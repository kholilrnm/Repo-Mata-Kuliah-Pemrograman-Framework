...
<html>
  <head>
    ...
    <!-- load css boostrap -->
    <link href="<?php echo base_url() . '/assets/assetDashboard/css/bootstrap.min.css'?>" rel="stylesheet">
    <link href="<?php echo base_url() . '/assets/assetDashboard/css/dashboard.css'?>" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <h2 style="margin: 30px 0 30px 0;">Form Edit Data</h2>
          <?php foreach ($data as $row) { ?>

          <form action="<?php echo base_url() . 'home/update_data'; ?>" method="POST">
            
            <div class="form-group">
              <label>Code</label>
              <input type="text" name="code" value="<?php echo $row->code?>" disabled/>
              <input type="text" class="form-control" placeholder="Code" name="code" required="required">
            </div>
            <div class="form-group">
              <label>Name</label>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="Num Airports" name="numAirports" required="required">
            </div>
            <div class="form-group">
              <label>City</label>
    ...
    <script src="'<?php echo base_url() . '/assets/assetDashboard/js/jquery.js'?>"></script>
    <script src="<?php echo base_url() . '/assets/assetDashboard/js/bootstrap.js'?>"></script>
  </body>
</html>